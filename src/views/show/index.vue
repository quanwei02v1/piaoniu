<template>
  <div class="big_box" >
    <BetScroll ref="listscroll">
      ...
      <div class="bot">
        ...
        <div class="promotion">
          ...
          <span class="promotion_1">{{sum}}</span>
          <span class="public"></span>
        </div>
        <div class="content_1">
          <ul>
      ...
      <div class="star_array">
        <div class="stars_head">
          ...
          <div class="stars_detail">
            <img :src="imgCons" alt />
            <div class="item_box">
              <div class="star-item_main">{{user}}</div>
    ...
    <v-touch tag="div" @tap="clickTo(activityEventId,num.id)">
...
export default {
  ...
  async activated() {
    ...
    let data = await show_api(this.id);
    this.address = data.venue.name;
    this.sum = data.campaigns.length ? data.campaigns[0].desc : "";
    this.user = data.activityLineup.length ? data.activityLineup[0].name : "";
    this.followNum = data.activityLineup.length ? data.activityLineup[0].followNum : "";
    this.imgCons = data.activityLineup.length ? data.activityLineup[0].avatar : "";
    this.activityEventId = data.ticketCategories[0].activityEventId;
    this.num = data;
    this.actorsId =  data.actors.length ? data.actors[0].id : "";
  },
  mounted() {
