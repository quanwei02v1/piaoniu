<template>
  <div class="page_nav">
    <div class="nav_head">
      <p></p>
      <div class="nav_con" @click="handlerClick()">
        <b></b>
      </div>
      <div class="nav_content">选择商品</div>
    </div>
    <div class="picker">
      <p>选择场次</p>
      <div class="header">
...
import { price_piao_api } from "api/list";
// export default {
//   name: "Price",
//  async created() {
//         document.title = this.$route.meta.title;
//     let data = await price_api();
//       this.list=data;
//       // console.log(this.list)

//     let mst=await price_piao_api();
//     // console.log(mst,111)
//       this.str=mst;
//     },
//   data() {
...
export default {
  ...
  async created() {
    ...
    if (!sessionStorage.getItem("str")) {
      let data = await price_piao_api(this.userid);
      this.str = data.events[0].specification;
      sessionStorage.setItem("str",JSON.stringify(data.events[0].specification)
      );
    }
  },
  async activated() {
...
.bottom_bar {
  ...
  display: flex;
  align-items: center;
  box-shadow: 0px 0px 0.05rem 0px #e6e6e6;
  background-color: #fff;
  z-index: 10;
}
.btn_confirm {
